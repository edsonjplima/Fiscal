            ...
            begin
             ...
             if (   (FrPar.cbb2.ItemIndex = 1)                      or
              ...
              begin
               ...
               if (DMFD.FDQuery2['vBCUFDest'] = null) then                   // 09-01-2019 (Renildo) foi mudado de vBCFCPUFDest para vBCUFDeste
                vBCFCPUFDest   := 0
               else
             ...
             if (DMFD.FDQuery2['pFCPUFDest'] = null) then
              pFCPUFDest     := 0
             else
             ...
             if (DMFD.FDQuery2['vFCPUFDest'] = null) then
              vFCPUFDest     := 0
             else
...
//               pFCP	       := Imposto.ICMSUFDest.pFCPUFDest;                    // Percentual relativo ao Fundo de Combate à Pobreza (FCP). Nota: Percentual máximo de 2%, conforme a legislação.
...
//               vFCP	       := Imposto.ICMSUFDest.vFCPUFDest;                    // Valor do ICMS relativo ao Fundo de Combate à Pobreza (FCP)
       ...
       if DMFD.FDQuery1['nfe_vFCPUFDest'] = null then
