...
type
  ...
  public
    ...
    procedure MarcaBlocoM( cxTLE : TcxTreeList; blMarca : Boolean; blTodos : Boolean = False ); // Marca bloco de seleção TreeList
...
begin
 ...
 stat1.Panels[1].Text := '  Aquarde, Selecionando destinatários!';
