...
GO
/****** Object:  StoredProcedure [dbo].[sp_nfe_inutilizadas]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_nfe_inutilizadas]
GO
/****** Object:  StoredProcedure [dbo].[sp_nfe_em_contingencia]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_nfe_em_contingencia]
GO
/****** Object:  StoredProcedure [dbo].[sp_nfe_denegadas]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_nfe_denegadas]
GO
/****** Object:  StoredProcedure [dbo].[sp_nfe_canceladas]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_nfe_canceladas]
GO
/****** Object:  StoredProcedure [dbo].[sp_nfe_a_serem_geradas]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_nfe_a_serem_geradas]
GO
/****** Object:  StoredProcedure [dbo].[sp_ler_nfe_textos]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_ler_nfe_textos]
GO
/****** Object:  StoredProcedure [dbo].[sp_le_nfe]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_le_nfe]
GO
/****** Object:  StoredProcedure [dbo].[sp_insere_notas_inutilizadas]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_insere_notas_inutilizadas]
GO
/****** Object:  StoredProcedure [dbo].[sp_importa_nfe]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_importa_nfe]
GO
/****** Object:  StoredProcedure [dbo].[sp_exclui_nfe]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_exclui_nfe]
GO
/****** Object:  StoredProcedure [dbo].[sp_consulta_nfe]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_consulta_nfe]
GO
/****** Object:  StoredProcedure [dbo].[sp_calcula_digito_chave]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_calcula_digito_chave]
GO
/****** Object:  StoredProcedure [dbo].[sp_bkp]    Script Date: 03/08/2018 14:31:27 ******/
DROP PROCEDURE [dbo].[sp_bkp]
GO
/****** Object:  StoredProcedure [dbo].[s_le_arquivo_texto]    Script Date: 03/08/2018 14:31:27 ******/
...
CREATE    proc [dbo].[sp_insere_notas_inutilizadas] @codigo_loja int,         @nota          bigint,       @ano           int,          @modelo int, 
												   ...
												   @CNPJ        varchar(14), @nProt         varchar(20)
as
...
and ( (( t1.dEmi between @data_inicio and @data_final ) and ( @Nota = 0 ) and ( @destinatario = 0 )) or
      ...
      (( t1.nnf = @nota or @Nota = 0 ) and ( t1.codigo_destinatario               = @destinatario )) )   -- By Edson Lima ; 2017/10/17 ---> Filtra perÌodo, nota e destinatario sem periodo 
and (t1.Modelo                 = @Modelo or @Modelo = '')                                                -- By Edson Lima ; 2015/11/27 ---> filtra por Modelo
and (t1.Serie                  = @Serie or @Serie = '')                                                  -- By Edson Lima ; 2016/02/11 ---> filtra por Serie
